...
## 在网页中会引用哪些常见的静态资源？
- JS   .js    .jsx(react)   .ts(TypeScript  类 C#语言)

- CSS  .css  .less .scss(sass)

- images  .jpg .png .gif  .svg

- 字体文件  .svg  .ttf .eot  .woff

- 模板文件 .art  .jade .vue .ejs

  


## 网页中引入的静态资源多了以后有什么问题？？？
1.网页加载速度慢，因为我们发起了很多的二次请求
...
2.可以使用requireJs、也可以使用即将要学的webpack解决各个文件、包之间复杂的依赖关系
...
## webpack安装的两种方式
1. 运行`npm i webpack webpack-cli -g`全局安装webpack webpack-cli，这样就能在全局使用webpack的命令

2. 在项目根目录中运行`npm i webpack webpack-cli --save-dev`安装到项目依赖中
...
```
webpack ./src/main.js -o ./dist/build --mode=development
```
